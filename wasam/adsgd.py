# Copy from  https://github.com/ymalitsky/adaptive_GD/blob/master/pytorch/optimizer.py
...
class Adsgd(Optimizer):
    ...
    Change default eps from 1e-5 to 1e-8
    """
    def __init__(self, params, lr=0.2, amplifier=0.02, theta=1, damping=1, eps=1e-8, weight_decay=0):
