...
def get_dataset(
    ...
    if "vit" in config.model:
        # https://github.com/jeonsworld/ViT-pytorch/blob/460a162767de1722a014ed2261463dbbc01196b6/utils/data_utils.py#L17
        train_transform = [
...
def get_train_valid_test_set(
    config: TrainConfig,
) -> Tuple[datasets.VisionDataset, Optional[datasets.VisionDataset], datasets.VisionDataset]:
...
def get_train_valid_test_loader(
    ...
    num_of_train_data = len(train_set)

    return num_of_train_data, train_loader, val_loader, test_loader
